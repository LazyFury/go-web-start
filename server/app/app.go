...
func New() *echo.Echo {
	...
	e.Use(middleware.CORSWithConfig(middleware.CORSConfig{
		...
		AllowHeaders:     []string{"token", "Content-Type", "Access-Control-Allow-Origin", echo.HeaderAcceptEncoding, echo.HeaderAccessControlAllowHeaders, echo.HeaderAccessControlAllowCredentials},
	}))
