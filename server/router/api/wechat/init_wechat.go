...
func login(c *gin.Context) {
	...
	if err != nil {
		response.Error(response.JSONError(err.Error(), WeChatUser))
	}
	...
	c.JSON(http.StatusOK, response.JSONSuccess(err.Error(), WeChatUser))
}
...
func userInfo(c *gin.Context) {
	...
	c.JSON(http.StatusOK, response.JSONSuccess("获取成功", user))
}
...
func jsAPIConfig(c *gin.Context) {
	...
	c.JSON(http.StatusOK, response.JSONSuccess("请求成功", conf))
}
